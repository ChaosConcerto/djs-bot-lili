...
module.exports = {
  ...
  else if (message.content === '色狗2') {
    const reply = await message.reply('https://media.discordapp.net/attachments/1020572202917167126/1102915259469152256/IMG_1975.png');
    reply.react('✅');
  }
